...
namespace op {
    ...
    template <typename T> struct negate_op {
        T operator() (long& a) const {
            return T(-a);
        }
    ...
    template <typename T> struct sub_op {
        T operator() (long& a, long& b) const {
            return T(a - b);
        }
    ...
    template <typename T> struct div_op {
        T operator() (long& a, long& b) const {
            return T(a / b);
        }
    ...
    template <typename T> struct gt_op {
        T operator() (long& a, long& b) const {
            return T((long)(a > b));
        }
    ...
    template <typename T> struct ge_op {
        T operator() (long& a, long& b) const {
            return T((long)(a >= b));
        }
    ...
    template <typename T> struct eq_op {
        T operator() (long& a, long& b) const {
            return T((long)(a == b));
        }
    ...
    template <typename T> struct ne_op {
        T operator() (long& a, long& b) const {
            return T((long)(a != b));
        }
    ...
    template <typename T> struct exp_op {
        T operator() (long& a, long& b) const {
            return T(pow(a, b));
        }
