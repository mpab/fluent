...
ostream& operator<<(ostream& o, const NodeInfo& ni)
{

    if (!ni.n) {
        return o << FMT24 << (void*)ni.n;
    }

    o << FMT24 << (void*)ni.n << FMT12 << ni.n->type_name() << ni.n;

    auto i = dynamic_cast<Instruction*>(const_cast<Node*>(ni.n));
